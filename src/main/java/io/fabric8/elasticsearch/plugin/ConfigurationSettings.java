...
public interface ConfigurationSettings extends KibanaIndexMode{
    ...
    static final String OPENSHIFT_CONTEXT_CACHE_EXPIRE_MINUTES = "openshift.context.cache.expireminutes";
    static final int DEFAULT_OPENSHIFT_CONTEXT_CACHE_MAXSIZE = 500;
    static final int DEFAULT_OPENSHIFT_CONTEXT_CACHE_EXPIRE_MINUTES = 2;
