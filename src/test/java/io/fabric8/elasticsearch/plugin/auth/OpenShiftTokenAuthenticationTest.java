...
public class OpenShiftTokenAuthenticationTest {
    ...
    public void testAuthenticate() throws Exception {
        OpenshiftAPIService apiService = mock(OpenshiftAPIService.class);
        ...
        User user = backend.authenticate(new AuthCredentials(username, context));
    ...
    public void testExtractCredentials() throws Exception {
        ...
        assertNotNull(creds.getNativeCredentials());
        assertEquals(context, creds.getNativeCredentials());
        assertEquals(context, threadContext.getTransient(ConfigurationSettings.OPENSHIFT_REQUEST_CONTEXT));
        assertTrue(threadContext.getTransient(OpenShiftTokenAuthentication.OPENSHIFT_AUTHENTICATOR));
