...
public class SearchGuardRolesMappingACLTest {
    ...
    public void testSeserialization() throws Exception {
        ...
        final String out = XContentHelper.convertToJson(sgMapping.toXContentBuilder().bytes(), true, XContentType.JSON);
        ...
        assertEquals("Exp serialization to equal derialization", out, XContentHelper.convertToJson(inMapping.toXContentBuilder().bytes(), true, XContentType.JSON));
    }
